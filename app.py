...
if uploaded_file is not None:
    ...
    st.write("Simple RNN, Open price prediction for future      :", simple_RNN_prediction[0,0])
    st.write("LSTM prediction, Open price prediction for future :", LSTM_prediction[0,0])
